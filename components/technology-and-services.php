    ...
    <div class="row">
        <div class="col">
            <div class="content__wrap">
                <h2 class="title">Technology &amp; Solutions</h2>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusamus, atque beatae cum doloribus ducimus excepturi fuga impedit ipsum nam nemo nesciunt numquam odit perspiciatis quae reiciendis similique tenetur ut voluptates.</p>
                <ul class="icon__list">
                    <li>
                        <div class="wrap">
